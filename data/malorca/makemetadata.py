...
if __name__ == "__main__":
    PATH_TO_ROOT = "/run/media/johnny/31c5407a-2da6-4ef8-95ec-d294c1afec38/MALORCA/DATA_ATC/VIENNA/DATA/"
    PATH_TO_LISTINGS_OF_FILES = ["test/wav.scp", "dev12/wav.scp"]
    DISK_PATH="/run/media/johnny/31c5407a-2da6-4ef8-95ec-d294c1afec38"
    SAVE_PATH=["./metadata_test.json", "./metadata_dev12.json"] # must corresponds to PATH_TO_LISTINGS_OF_FILES
