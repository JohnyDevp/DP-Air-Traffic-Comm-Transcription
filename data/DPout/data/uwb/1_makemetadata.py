...
if __name__ == "__main__":
    ...
    path_to_wavs = f'{DISK_ROOT}/{FOLDER_NAME}/audio'
    ...
    path_to_save_new_wavs = os.path.join(DISK_ROOT,f'{FOLDER_NAME}/audio_split') 
    ...
    parsed_wavs = parseStm(os.path.join(DISK_ROOT, f'{FOLDER_NAME}/stm/stm'))
