...
if __name__ == '__main__':
    ...
    FOLDERS_TO_SEARCH = [f'{FOLDER_NAME}/DATA_nonEN',f'{FOLDER_NAME}/DATA', f'{FOLDER_NAME}/DATA_nonEN-datanonen-EN', f'{FOLDER_NAME}/DATA-data-nonEN']
    ...
    for file in METADATA_PATHS:
        with open(file,'r') as f:
            ...
            for meta in tqdm(js_file):
                ...
                for fl in FOLDERS_TO_SEARCH:
                    ...
                    if os.path.exists(p):
                        ...
                        break
                if not path: 
                    print(f'{rec_file} not found (originally {meta['audio']})!')
                    continue
            ...
            json.dump(js_file, open(file,'w'),indent=4,ensure_ascii=False)
            f.close()
