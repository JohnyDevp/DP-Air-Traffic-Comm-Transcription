...
# DIR=models/planned-vanmed-fullts/dropout       # CHANGE THIS LINE
# EXPER_NAME_DIRS=do                    # CHANGE THIS LINE
# DST=./vanmed/30/dropout                           # CHANGE THIS LINE
# #======================================================
DIR=models/planned-allds-fullts/30/warmup       # CHANGE THIS LINE
EXPER_NAME_DIRS=wr                              # CHANGE THIS LINE
DST=./allds/30/warmup                           # CHANGE THIS LINE
